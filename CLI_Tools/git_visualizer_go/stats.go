...
// starts calculates and prints the stats.
...
// getBeginningOfDay givae a time.Time calculates the start time of that day
...
func fillCommits(email string, path string, commits map[int]int) map[int]int {
	...
	//get commits history starting from the HEAD
...
func processRepositories(email string) map[int]int {
	...
	repos := parseFileLinnesToSlice(filePath)
